...
FIXED VERSION - Handles Windows paths correctly
"""
...
cred = credentials.Certificate(r'C:\Users\Admin\Downloads\dormfinder-98225-firebase-adminsdk-fbsvc-73a57fdc3a.json')

# OPTION 2: Use forward slashes (also works on Windows)
# cred = credentials.Certificate('C:/Users/Admin/Downloads/dormfinder-98225-firebase-adminsdk-fbsvc-73a57fdc3a.json')
...
if __name__ == "__main__":
    # Path to your Excel file (using raw string for Windows paths)
    excel_file = r"C:\Users\Admin\AndroidStudioProjects\DormFinder\dorms_firebase_import.json"
    
    # Or find the Excel file in the same directory as this script
    script_dir = os.path.dirname(os.path.abspath(__file__))
    excel_file = os.path.join(script_dir, "Dormitory_and_Boarding_House_Listing_Form__Responses_.xlsx")
    ...
    if not os.path.exists(excel_file):
        ...
        print("\nPlease make sure the Excel file is in the same directory as this script")
